...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      githubUrl: "https://github.com/pacharasesangngam/Discord-Shop",
      icon: Code,
      featured: true,
      complexity: 4,
      duration: "1 เดือน",
    ...
    },
    {
      ...
      githubUrl: "https://github.com/pacharasesangngam/ROBLOXSHOP",
      icon: Smartphone,
      featured: false,
      complexity: 5,
      duration: "1 month",
    ...
    },
    {
      ...
      githubUrl: "https://github.com/pacharasesangngam/RobloxWEBLOG",
      icon: Database,
      featured: false,
      complexity: 4,
      duration: "2.5 months",
